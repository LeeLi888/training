...
import com.amf.newsletter.service.NewsletterLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.amf.newsletter.service.impl.NewsletterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.amf.newsletter.service.impl.NewsletterLocalServiceImpl
 * @generated
 */
public abstract class NewsletterLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NewsletterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>NewsletterLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return newsletterPersistence.dslQuery(dslQuery);
	}
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(newsletterLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = NewsletterLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, newsletterLocalService);
		}
