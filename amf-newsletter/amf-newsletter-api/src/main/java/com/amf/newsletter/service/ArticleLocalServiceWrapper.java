...
public class ArticleLocalServiceWrapper
	 ...
	 */
	@Override
	public com.amf.newsletter.model.Article addArticle(
		com.amf.newsletter.model.Article article) {
	...
	@Override
	public com.amf.newsletter.model.Article getArticleByJournalArticleId(
			String journalArticleId)
		throws com.amf.newsletter.exception.NoSuchArticleException {

		return _articleLocalService.getArticleByJournalArticleId(
			journalArticleId);
	}
	 ...
	 */
	@Override
	public java.util.List<com.amf.newsletter.model.Article> getArticles(
		int start, int end) {
	 ...
	 */
	@Override
	public com.amf.newsletter.model.Article updateArticle(
		com.amf.newsletter.model.Article article) {
