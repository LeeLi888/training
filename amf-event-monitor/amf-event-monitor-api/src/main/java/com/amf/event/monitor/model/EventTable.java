...
/**
 * The table class for the &quot;AmfEventMonitor_Event&quot; database table.
 *
...
public class EventTable extends BaseTable<EventTable> {
	...
	public final Column<EventTable, String> clientIp = createColumn(
	...
	private EventTable() {
		super("AmfEventMonitor_Event", EventTable::new);
	}
