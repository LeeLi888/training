...
public interface MemberLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Member> getMembersByCompanyIdAndZipCode(
