...
import com.amf.user.profile.exception.NoSuchGeneralProfileException;
import com.amf.user.profile.model.GeneralProfile;
import com.amf.user.profile.model.GeneralProfileTable;
...
import com.amf.user.profile.service.persistence.GeneralProfileUtil;
 ...
 * @generated
 */
@Component(service = {GeneralProfilePersistence.class, BasePersistence.class})
public class GeneralProfilePersistenceImpl
	...
	public GeneralProfilePersistenceImpl() {
		...
		setTable(GeneralProfileTable.INSTANCE);
	}
	...
	public void cacheResult(List<GeneralProfile> generalProfiles) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (generalProfiles.size() > _valueObjectFinderCacheListThreshold))) {
	...
	public void clearCache() {
		...
		finderCache.clearCache(GeneralProfileImpl.class);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {generalProfileModelImpl.getUserId()};

		finderCache.putResult(_finderPathCountByUserId, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUserId, args, generalProfileModelImpl);
	}
	...
	public void activate() {
		...
		_setGeneralProfileUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setGeneralProfileUtilPersistence(null);

		entityCache.removeCache(GeneralProfileImpl.class.getName());
	}

	private void _setGeneralProfileUtilPersistence(
		GeneralProfilePersistence generalProfilePersistence) {

		try {
			Field field = GeneralProfileUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, generalProfilePersistence);
		}
	...
	@Reference
	private GeneralProfileModelArgumentsResolver
		_generalProfileModelArgumentsResolver;
