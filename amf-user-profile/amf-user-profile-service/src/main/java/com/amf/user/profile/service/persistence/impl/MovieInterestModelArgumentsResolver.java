...
/**
 * The arguments resolver class for retrieving value from MovieInterest.
 *
...
@Component(
	immediate = true,
	service = {
		MovieInterestModelArgumentsResolver.class, ArgumentsResolver.class
	}
)
public class MovieInterestModelArgumentsResolver implements ArgumentsResolver {
	...
	public String getClassName() {
		return MovieInterestImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return MovieInterestTable.INSTANCE.getTableName();
	}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				arguments[i] = movieInterestModelImpl.getColumnOriginalValue(
					columnName);
			}
			else {
