...
import com.amf.user.profile.service.FavoriteGenreService;
 ...
 * @generated
 */
public abstract class FavoriteGenreServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FavoriteGenreService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FavoriteGenreService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FavoriteGenreServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FavoriteGenreService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		favoriteGenreService = (FavoriteGenreService)aopProxy;

		_setServiceUtilService(favoriteGenreService);
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FavoriteGenreServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, favoriteGenreService);
		}
	...
	@Reference
	protected com.amf.user.profile.service.FavoriteGenreLocalService
		favoriteGenreLocalService;

	protected FavoriteGenreService favoriteGenreService;
