...
/**
 * Provides the local service interface for FavoriteGenre. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FavoriteGenreLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FavoriteGenreLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.amf.user.profile.service.impl.FavoriteGenreLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the favorite genre local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FavoriteGenreLocalServiceUtil} if injection and service tracking are not available.
	 */
