...
public interface EventLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Event> getEventsByCompanyIdAndEventType(
		long companyId, String eventType, int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Event> getEventsByCompanyIdAndUserId(
		long companyId, long userId, int start, int end);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Event> getEventsByCompanyIdAndUserIdAndEventType(
