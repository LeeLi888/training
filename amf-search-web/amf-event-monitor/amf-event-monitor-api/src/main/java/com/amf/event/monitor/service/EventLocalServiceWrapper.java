...
public class EventLocalServiceWrapper
	 ...
	 */
	@Override
	public com.amf.event.monitor.model.Event addEvent(
		com.amf.event.monitor.model.Event event) {
	 ...
	 */
	@Override
	public com.amf.event.monitor.model.Event createEvent(long eventId) {
	 ...
	 */
	@Override
	public com.amf.event.monitor.model.Event deleteEvent(
		com.amf.event.monitor.model.Event event) {
	 ...
	 */
	@Override
	public com.amf.event.monitor.model.Event deleteEvent(long eventId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.amf.event.monitor.model.Event fetchEvent(long eventId) {
	 ...
	 */
	@Override
	public com.amf.event.monitor.model.Event getEvent(long eventId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.amf.event.monitor.model.Event> getEvents(
		int start, int end) {
	...
	public java.util.List<com.amf.event.monitor.model.Event>
		...
		return _eventLocalService.getEventsByCompanyIdAndEventType(
	...
	public java.util.List<com.amf.event.monitor.model.Event>
		...
		return _eventLocalService.getEventsByCompanyIdAndUserId(
	...
	public java.util.List<com.amf.event.monitor.model.Event>
		...
		return _eventLocalService.getEventsByCompanyIdAndUserIdAndEventType(
	...
	public long getEventsCountByCompanyIdAndEventType(
		...
		return _eventLocalService.getEventsCountByCompanyIdAndEventType(
			companyId, eventType);
	}

	@Override
	public int getEventsCountByCompanyIdAndUserId(long companyId, long userId) {
		return _eventLocalService.getEventsCountByCompanyIdAndUserId(
			companyId, userId);
	}
	 ...
	 */
	@Override
	public com.amf.event.monitor.model.Event updateEvent(
		com.amf.event.monitor.model.Event event) {
