 ...
 * <code>com.amf.registration.service.impl.UserExternalLocalServiceImpl</code> and
...
public class UserExternalLocalServiceUtil {
	 ...
	 */
	public static UserExternal addUserExternal(UserExternal userExternal) {
	 ...
	 */
	public static UserExternal createUserExternal(long userExternalId) {
		return getService().createUserExternal(userExternalId);
	}
	 ...
	 */
	public static UserExternal deleteUserExternal(long userExternalId)
		throws PortalException {

		return getService().deleteUserExternal(userExternalId);
	}
	 ...
	 * @return the user external that was removed
	 */
	public static UserExternal deleteUserExternal(UserExternal userExternal) {
	...
	public static UserExternal fetchUserExternal(long userExternalId) {
		return getService().fetchUserExternal(userExternalId);
	}
	 ...
	 * @throws PortalException if a user external with the primary key could not be found
	 */
	public static UserExternal getUserExternal(long userExternalId)
		throws PortalException {

		return getService().getUserExternal(userExternalId);
	}
	 ...
	 */
	public static List<UserExternal> getUserExternals(int start, int end) {
	 ...
	 */
	public static UserExternal updateUserExternal(UserExternal userExternal) {
	...
	private static volatile UserExternalLocalService _service;
